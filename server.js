...
Recipes.create('Peanut Butter and Jelly',['bread','peanut butter','jelly']);
Recipes.create('rice and beans',['rice','beans','cilantro','water','love']);
Recipes.create('Chocolate Milk',['cream','whole milk','chocolate']);
